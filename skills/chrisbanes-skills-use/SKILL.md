...
| Other | `implement-issue` | `references/implement-issue/DOC.md` | Use when asked to review, fix, implement, resolve, or work through a specific GitHub, GitLab, Jira, or Linear issue reference. |
