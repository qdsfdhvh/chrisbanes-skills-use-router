...
5. Keep animated `State` in layout or draw block modifiers when it changes at frame rate; route deeper diagnosis to [Compose performance](../compose-performance/DOC.md).
...
- For side-effect timing or click-launched work, use [Compose state and effects](../compose-state-and-effects/DOC.md).
- For deep state-read or recomposition diagnosis, use [Compose performance](../compose-performance/DOC.md).
