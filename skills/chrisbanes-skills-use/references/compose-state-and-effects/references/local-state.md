...
- **`rememberLazyListState` / `rememberScrollState`** used for frame-rate reads → [Compose performance](../../compose-performance/DOC.md)
...
enough. See [Compose performance](../../compose-performance/DOC.md) for
...
navigation](../../compose-focus-navigation/DOC.md); **when** to call
